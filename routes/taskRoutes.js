...
taskRouter.put("/:projectId/tasks/:taskId", async (req, res) => {
  try {
    ...
    if (error)
      return res
        .status(error === "Not authorized" ? 403 : 404)
        .json({ message: error });
...
// PUT http://localhost:4000/api/projects/6933bd2729ca2c9f02f1f427/tasks (projectId) to create task
// {
//     "title": "tasks for 1st project changed",
//     "description": "tasks for 1st project changed"
//    }

// DELETE http://localhost:4000/api/projects/6937aeb391ba904767a3a125 (projectId) to delete project and belongs all tasks

// DELETE http://localhost:4000/api/projects/6937aeb391ba904767a3a125/tasks/6937af1491ba904767a3a12b (taskId) to delete only task

// PUT http://localhost:4000/api/projects/6937aeb391ba904767a3a125/tasks/6937af1491ba904767a3a12b (taskId) to save edited task/(to change task)
// {
